...
#define     FSR_EBI2ND_REG_BASE                 (0xa0a00000)
#else
#define     FSR_EBI2ND_REG_BASE                 (0xc1100000)
#endif

#define     MSM7200_SHARED_MEMORY_BASE          (0x01FFB000)
...
FSR_PAM_InitNANDController(VOID)
{
    ...
    if (!bInitFlag)
    {
	    ...
	    gpEBI2NDReg->nFLASH_XFR_STEP1_ADDR = (0x43804380|1<<26|1<<10);
	    gpEBI2NDReg->nFLASH_XFR_STEP2_ADDR = (0x039003A0|0<<26|0<<10);
	    gpEBI2NDReg->nFLASH_XFR_STEP3_ADDR = (0x03B000A8|0<<26|1<<11);
	    gpEBI2NDReg->nFLASH_XFR_STEP4_ADDR = (0x01B480A0|1<<26|1<<11);
	    gpEBI2NDReg->nFLASH_XFR_STEP5_ADDR = (0x81A2C020|0<<26|1<<10);
	    gpEBI2NDReg->nFLASH_XFR_STEP6_ADDR = (0xC020C020|1<<26|0<<10);
	    gpEBI2NDReg->nFLASH_XFR_STEP7_ADDR = (0xC020C020|0<<26|0<<10);

	    gpEBI2NDReg->nSFLASHC_BURST_CFG_ADDR = 0x20100327;
...
FSR_PAM_CreateSL(UINT32* pHandle, UINT32 nLayer)
{
    ...
    FSR_OAM_CreateSM(pHandle, FSR_OAM_SM_TYPE_BML);
