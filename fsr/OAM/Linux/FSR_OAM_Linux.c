...
/* 
 * spinlock baseaddr = shared memory base - spinlock offset
 * spinlock offset(0x4FF0) = 
 * MSM7200_SHARED_MEMORY_BASE(0x01FFB000) - FSR_SMEM_SPINLOCK_BASEADDR(0x01FFFFF0)
 */
...
PRIVATE     UINT32          gnShMemBaseAddress[FSR_MAX_VOLS]    = {0x0,0};
PRIVATE     UINT32          gnShMemMaxSize[FSR_MAX_VOLS]        = {0x0,0};
PRIVATE     UINT32          gnSMallocPtr[FSR_MAX_VOLS]          = {0,0};
PRIVATE     UINT32          gnShMemResetPtr[FSR_MAX_VOLS]    = {0,0};
                ...
                UINT32      nMemType)
{
    ...
    {
#if defined(FSR_USE_DUAL_CORE)
        FSR_OAM_ResetMalloc(nVol, FALSE32);
#endif
    }
}
