...
#define     FSR_SMEM_SPINLOCK_BASEADDR          (0x01FFFFF0)
#define     FSR_SMEM_SPINLOCK_BML               (0) //0x01FFFFF0
#define     FSR_SMEM_SPINLOCK_BOOT              (1) //0x01FFFFF4
#define     FSR_SMEM_SPINLOCK_FS_REBUILD        (2) //0x01FFFFF8
