...
/**
 *  @file       FSR_STL_TblCRC.c
 *  @brief      This function contains CRC32 table info.
 *  @author     Jongtae Park
 *  @date       27-JUNE-2007
 *  @remark
 *  REVISION HISTORY
 *  @n  27-JUNE-2007 [Jongtae Park] : first writing for orange V1.2.0
 */
...
PUBLIC const UINT32 CRC32_Table[4][256] = {
{
