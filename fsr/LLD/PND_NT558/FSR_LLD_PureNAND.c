...
//TODO TODO TODO add error handle for this 3 porting function.
extern  INT32 NTK_NFCON_ReadPage(UINT32 nDev, UINT32 nRowAddress, UINT32 nColAddress);
extern  INT32 NTK_NFCON_ProgramPage(UINT32 nDev, UINT32 nRowAddress, UINT32 nColAddress);
extern  INT32 NTK_NFCON_ERASE(UINT32 nDev, UINT32 nRowAddress, UINT32 nColAddress);

//===========================================================
// hal functions
//===========================================================
extern UINT32 NFC_Init(void);
extern UINT32 NFC_NAND_REIN(void);
extern UINT32 NFC_ReadID(NANDIDData    *pstNANDID);
extern UINT32 NFC_GetECCBits(UINT32 subpage_cnt) ;
extern UINT32 NFC_ReadPage_FreeRun( PureNANDSpec *pstPNDSpec , UINT32 dwPageAddr, UINT8 *pu8_DataBuf, UINT8 *pu8_SpareBuf);
extern UINT32 NFC_WritePage_FreeRun( PureNANDSpec *pstPNDSpec , UINT32 dwPageAddr, UINT8 *dwBuffer, UINT8 *dwExtraBuffer);
extern UINT32 NFC_ReadPage(PureNANDSpec *pstPNDSpec, UINT32 dwPageAddr, UINT8 *pu8_DataBuf, UINT8 *pu8_SpareBuf);
extern UINT32 NFC_EraseBlock(PureNANDSpec *pstPNDSpec, UINT32 dwPageAddr);
extern UINT32 NFC_WritePage(PureNANDSpec *pstPNDSpec, UINT32 dwPageAddr, UINT8 *pu8_DataBuf, UINT8 *pu8_SpareBuf);
extern UINT32 NFC_Reset(void);
extern UINT8 NFC_ReadStatus(void);
extern UINT32 NFC_SetType(PureNANDSpec  *pstPNDSpec);
...
//		Debug Function
//===========================================================
extern void hex_dump(UINT8 *pu8Data, UINT32 u32Length);
...
void delay_p1_us(unsigned long count)
{
	unsigned long i;
...
UINT8            *SpareRAM;
UINT32		 nRow;
EXPORT_SYMBOL(MainRAM);
EXPORT_SYMBOL(SpareRAM);
#endif
