...
{
	unsigned int *bootcfg;
#define VA_IO_BASE0 0x30000000
#define BOOTCFG 0x000d0020
#define BOOTCFG_SIZE    4
#define BOOTCFG_SHIFT 4
#define BOOTCFG_MASK 0x3
#define EMMCBOOT 2

	bootcfg = (unsigned int) ioremap(VA_IO_BASE0 + BOOTCFG , BOOTCFG_SIZE);
	if (((*bootcfg >> BOOTCFG_SHIFT) & BOOTCFG_MASK) == EMMCBOOT ) {
		return;
	}
