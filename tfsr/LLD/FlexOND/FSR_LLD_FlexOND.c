...
#define     FSR_READ_PRELOADED_DATA
//#define     FSR_RUNTIME_ERASE_REFRESH

//read count for erase refresh
#if defined(FSR_RUNTIME_ERASE_REFRESH)
#define    FSR_RUNTIME_ER_MAX_READ_CNT        1000
#endif
...
#if defined (FSR_READ_PRELOADED_DATA)
