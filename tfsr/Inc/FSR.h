...
#define     FSR_VER_MINOR2          0       /** FSR minor2 version           */
#define     FSR_VER_PATCHLEVEL      0       /** FSR patch version            */
#define     FSR_BUILD_NUMBER        96      /** FSR build number             */
...
#define     FSR_VERSION_STR(major, minor1, minor2, patchlevel, buildnum) \
            #major "." #minor1 "." #minor2 "p" #patchlevel "_" "b0" #buildnum "_" FSR_VERSION_RCX
#else
#define     FSR_VERSION_STR(major, minor1, minor2, patchlevel, buildnum) \
            #major "." #minor1 "." #minor2 "_" "b0" #buildnum "_" FSR_VERSION_RCX
